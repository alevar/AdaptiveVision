...
Mat processImage(Mat &image, Features featuresTPL){
    ...
    createTrackbar("VAL1", "TEMPLATE CALIBRATION", val1, 100);
    createTrackbar("VAL2", "TEMPLATE CALIBRATION", val2, 100);
    createTrackbar("VAL3", "TEMPLATE CALIBRATION", val3, 100);
    createTrackbar("VAL4", "TEMPLATE CALIBRATION", val4, 100);
    createTrackbar("VAL5", "TEMPLATE CALIBRATION", val5, 100);

    while(true){

        mser(val1/(double)100,val2/(double)100,val3/(double)100,val4/(double)100,val5/(double)100);
...
vector<Point> maxMser(Mat *gray)
{
    ...
    vector<Point> mserF
     ...
     = max_element(msers.begin(), msers.end(), [] (vector<Point> &m1, vector<Point> &m2) {
