// g++ -std=c++11 -o testHistReturn testHistReturn.cpp `pkg-config opencv --cflags --libs`
...
int main( int argc, char** argv ){
    ...
    while(true){
        ...
        if(!threshSet){
            ...
            inputTHRESH = imread("/home/sparrow/Pictures/Webcam/clc4.jpg");
            imshow("ORIGINAL",inputTHRESH);
