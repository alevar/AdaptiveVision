...
=======================================================*/
	...
	match.compute();
	match.extractSample();
	imageTest1 = match.getSampleMAT();
	imageTest = imageTest1.clone();
	...
	image = (imageTest.reshape(0,1));
	int  imgSize = imageTest.total()*imageTest.elemSize();
...
=======================================================*/
	...
	while(connectionStatus){
		...
		// imshow("SAMPLE",imageTest);
		// waitKey(0);

		// image = imread("/home/sparrow/Pictures/Webcam/logoT.jpg",0);

		cout << "Width : " << imageTest.size().width << endl;
		cout << "Height: " << imageTest.size().height << endl;
